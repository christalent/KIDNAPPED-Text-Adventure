...
class GameState:
    ...
    def reset_floor_flags(self):
        ...
        # Floor 1 flags
        self.rope_stakes = False
        self.rope_stretched = False
        self.piano_done = False
...
class KidnappedGame:
    ...
    def build_rooms(self):
        ...
        # ============= FLOOR 3 - POOL / GREENHOUSE =============
        # Room 78: Greenhouse (original room 73 shifted to 78)
        rooms[78] = {"name": "GREENHOUSE", "desc": "YOU ARE IN A GREENHOUSE FILLED WITH EXOTIC PLANTS. STRANGE VINES HANG FROM THE CEILING. THE AIR IS THICK AND HUMID.", "exits": {}, "items": [], "floor": 3}
        
        # Room 77: Entry to Floor 3 from Floor 4
        rooms[77] = {"name": "POOL CHAMBER", "desc": "YOU ARE IN A LARGE CHAMBER WITH A SWIMMING POOL. THE WATER IS CLEAR AND INVITING. STRANGE FISH SWIM IN THE POOL. STAIRS LEAD UP TO FLOOR 4.", "exits": {"U": 72}, "items": [], "floor": 3}
        
        # ============= FLOOR 2 - QUICKSAND =============
        # (shifted from 81 to 82)
        rooms[82] = {"name": "BASEMENT LEVEL", "desc": "YOU ARE ON THE BASEMENT LEVEL.", "exits": {}, "items": [], "floor": 2}
        
        # ============= FLOOR 1 - EXIT =============
        # (shifted from 91 to 92)
        rooms[92] = {"name": "GROUND FLOOR", "desc": "YOU ARE ON THE GROUND FLOOR. FREEDOM IS NEAR!", "exits": {}, "items": [], "floor": 1}
    ...
    def do_drink(self):
        ...
        # Floor 3: Original Jekyll/Hyde location (room 18 in original = 73 in Python)
        if self.state.location == 73 and self.state.floor == 3:
            if self.state.jekyll_mode:
                print("YOU ALREADY DRANK THE POTION AND BECAME HYDE!")
                return
